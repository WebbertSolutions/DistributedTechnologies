...
namespace CustomSwagger
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // TODO: API Version - 01 - Custom Swagger
            ...
            // TODO: API Version - 02 - Custom Swagger
            SwaggerExtensions.ConfigureServices(services, true);
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IApiVersionDescriptionProvider apiProvider)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                SwaggerExtensions.Configure(app, apiProvider);  // TODO: API Version - 03 - Custom Swagger
            }

            app.UseHttpsRedirection();

            app.UseApiVersioning(); // TODO: API Version - 04 - Custom Swagger
